...
export function dia9() {
    ...
    function explorarDia9() {
        ...
        if (chance(0.50)) {
            ...
            let decisao = prompt('Ele parece ter muitos mantimentos. O que você deseja fazer?\n\n' +
                '1 - Enfrenta-los\n' +
